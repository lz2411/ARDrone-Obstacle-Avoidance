...
double median(double* arr , int SIZE, int zeros, FILE* f){
    ...
    //if(result > 0.01 ){
        ...
        //printf(" \n  no of zero %d \n  ",zeros);
        fprintf(f, " \n  no of zero %d \n  ",zeros);
        //printf("The median of the array was %.6f \n" , result); 
        fprintf(f, "The median of the array was %.6f \n" , result);  // could do appending instead
    //}
