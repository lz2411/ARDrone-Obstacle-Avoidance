...
inline C_RESULT demo_navdata_client_process( const navdata_unpacked_t* const navdata )
{
	...
	const navdata_raw_measures_t* const nraw = &navdata->navdata_raw_measures;
	...
	printf("Accelerometer : [Ax] %i [Ay] %i [Az] %i\n",nraw->raw_accs[ACC_X],nraw->raw_accs[ACC_Y],nraw->raw_accs[ACC_Y]);
	printf("Gyroscope     : [Wx] %i [Wy] %i [Wz] %i\n",nraw->raw_gyros[GYRO_X],nraw->raw_gyros[GYRO_X],nraw->raw_gyros[GYRO_X]);
